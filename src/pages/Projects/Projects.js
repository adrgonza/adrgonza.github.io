...
const Projects = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (activeProject && overlayRef.current && !overlayRef.current.contains(e.target)) {
    ...
    <div className="projects-container">
      <div className="projects-carousel">
        ...
        <div className="projects-item pixel-pong">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('pixelpong')}></div>
          <div className="expand-button" onClick={() => handleOpen('pixelpong')}>+</div>
        </div>
        ...
        <div className="projects-item mineworld">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('mineworld')}></div>
          <div className="expand-button" onClick={() => handleOpen('mineworld')}>+</div>
        </div>
        ...
        <div className="projects-item orionplat">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('orionplat')}></div>
          <div className="expand-button" onClick={() => handleOpen('orionplat')}>+</div>
        </div>
        ...
        <div className="projects-item midlands">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('midlands')}></div>
          <div className="expand-button" onClick={() => handleOpen('midlands')}>+</div>
        </div>
        ...
        <div className="projects-item matcha">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('matcha')}></div>
          <div className="expand-button" onClick={() => handleOpen('matcha')}>+</div>
        </div>
        ...
        <div className="projects-item minishell">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('minishell')}></div>
          <div className="expand-button" onClick={() => handleOpen('minishell')}>+</div>
        </div>
        ...
        <div className="projects-item irc">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('irc')}></div>
          <div className="expand-button" onClick={() => handleOpen('irc')}>+</div>
        </div>
        ...
        <div className="projects-item portfolio">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('portfolio')}></div>
          <div className="expand-button" onClick={() => handleOpen('portfolio')}>+</div>
        </div>
        ...
        <div className="projects-item youthbook">
          ...
          <div className="card-overlay-link" onClick={() => handleOpen('youthbook')}></div>
          <div className="expand-button" onClick={() => handleOpen('youthbook')}>+</div>
        </div>
      </div>
